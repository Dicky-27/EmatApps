...
//    clippingPath.addLine(to: CGPoint(x: columnXPoint2(graphPoints2.count - 1), y: height))
//    clippingPath.addLine(to: CGPoint(x: columnXPoint2(0), y: height))

    clippingPath.close()

    clippingPath.addClip()
    
//    guard let clippingPath2 = graphPath2.copy() as? UIBezierPath else {
//      return
//    }
//
//    clippingPath2.addLine(to: CGPoint(x: columnXPoint2(graphPoints2.count - 1), y: height))
//    clippingPath2.addLine(to: CGPoint(x: columnXPoint2(0), y: height))
//    clippingPath2.close()
//
...
//    let highestYPoint2 = columnYPoint2(maxValue)
//    startPoint = CGPoint(x: margin, y: highestYPoint)
//    endPoint = CGPoint(x: margin, y: self.bounds.height)
//
//    context.drawLinearGradient(
...
//
//    linePath2.move(to: CGPoint(x: margin, y: topBorder))
//    linePath2.addLine(to: CGPoint(x: width - margin, y: topBorder))
//
//    linePath2.move(to: CGPoint(x: margin, y: graphHeight / 2 + topBorder))
//    linePath2.addLine(to: CGPoint(x: width - margin, y: graphHeight / 2 + topBorder))
//
//    linePath2.move(to: CGPoint(x: margin, y: height - bottomBorder))
//    linePath2.addLine(to: CGPoint(x: width - margin, y: height - bottomBorder))
//    let color2 = UIColor(white: 1.0, alpha: Constants.colorAlpha)
//    color2.setStroke()
//
